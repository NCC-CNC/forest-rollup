...
OUTPUT <- "C:/Data/National/Landcover/NFIS/CA_forest_VLCE2_2019/FOREST_COMPOSITE_30m_VLCE2_2019_WF_CB_AAFC_LUTS_2020.tif"
...
FOREST_COMPOSITE_30m_VLCE2_2019_AAFC_LUTS_2020 <- terra::mosaic(rsrc)

writeRaster(FOREST_COMPOSITE_30m_VLCE2_2019_AAFC_LUTS_2020,
  filename = OUTPUT,
